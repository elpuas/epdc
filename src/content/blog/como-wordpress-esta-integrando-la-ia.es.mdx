...
<div class="blog-hero-image">
    {HeroImage && <Image width={1020} height={510} src={HeroImage} alt="Retrato del autor para el artículo sobre la integración de IA en WordPress" />}
</div>
...
[Contáctanos](mailto:management@elpuasdev.com) hoy!</p>
</div>
