...
<div class="blog-hero-image">
    {HeroImage && <Image width={1020} height={510} src={HeroImage} alt="Author portrait for the article about AI integration in WordPress" />}
</div>
...
add_action('init', function () {
	$response = AiClient::prompt('Summarize in 100 words why to use blocks in WordPress.')
