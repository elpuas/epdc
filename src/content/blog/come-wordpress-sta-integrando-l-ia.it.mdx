...
image: "/posts/post-gianfranco.jpg"
date: "2025-09-15"
author: Gianfranco Navas
---

import HeroImage from '../../../public/posts/post-gianfranco.jpg';
import Telex from '../../../public/posts/telex.png'
...
add_action('init', function () {
	$response = AiClient::prompt('Riassumi in 100 parole perché usare i blocchi in WordPress.')
